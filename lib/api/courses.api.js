...
export async function createCourseBatch(courseId, payload) {
  const res = await api.post(`/api/admin/courses/${courseId}/batches`, payload);
  return res.data;
}

export async function updateCourseBatch(batchId, payload) {
  const res = await api.patch(`/api/admin/courses/batches/${batchId}`, payload);
  return res.data;
}

export async function deleteCourseBatch(batchId) {
  const res = await api.delete(`/api/admin/courses/batches/${batchId}`);
  return res.data;
}